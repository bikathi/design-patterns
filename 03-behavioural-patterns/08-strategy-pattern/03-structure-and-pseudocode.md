...
![Solution Image](./media/strategy-pattern-uml.png)
...
2. The **Strategy** interface is common to all concrete strategies. It declares a method the context uses to execute a
   strategy.
3. **Concrete Strategies** implement different variations of an algorith the context uses.
...
5. The **Client** creates a specific strategy object and passes it to the context, which in turn exposes a setter to allow
   altering of the selected strategy at runtime.
