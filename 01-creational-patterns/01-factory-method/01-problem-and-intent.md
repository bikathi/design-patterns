...
- Later on, you decide that you want to incorporate sea logistics into the app, how would the updated code look like?
- In it's current state, most of your code is coupled to the *Truck* class.
...
- You will end up with a lot of bad, nasty code full of *if* statements that **switch** the apps behaviour depending 
